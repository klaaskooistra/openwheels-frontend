...
angular.module('owm.pages.rentavan', ['owm.resource', 'slick'])

//Module in app/pages/pagesModule.js
.controller('LandingController', function ($scope, $translate, resourceQueryService, $state, VERSION, resourceService) {
